...
class CoWebApp(coweb.AppContainer):
    ...
    def on_configure(self):
        ...
        self.webSecretKey = '2beb8d71c2954cad91255392a197300c'
        ...
        self.webStaticRoot = self.webRoot + 'pragmatico/www/'

        # absolute url of the coweb admin handler
        self.webAdminUrl = self.webRoot + 'pragmatico/admin'

        # absolute url of all coweb session handlers
        # self.webSessionRoot = self.webRoot + 'session/'

        # absolute url of all coweb session service handlers
        # self.webServiceRoot = self.webRoot + 'service/'
